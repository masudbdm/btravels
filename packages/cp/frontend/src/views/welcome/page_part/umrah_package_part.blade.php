<div class="row">
    <h3>Popular Umrah Packages</h3>
    <div class="col-md-9">
        <p>Our popular Umrah packages have been meticulously crafted to ensure a seamless and
            memorable journey. We prioritize our member's comfort, safety, and well-being throughout their Umrah  pilgrimage, providing a worry-free experience.</p>
    </div>

    <div class="col-md-3">
        @if ($umrahPackages->count() > 3)
...
<div class="row mt-4 d-flex">
    @foreach ($umrahPackages as $tourPackage)

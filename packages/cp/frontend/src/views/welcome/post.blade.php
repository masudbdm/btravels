                            ...
                            <article class="post post-large blog-single-post border-0 m-0 p-0">
                                <div class="post-content ms-0">
                                    ...
                                    <h2 class="font-weight-semi-bold"><a href="{{ route('singlePost', ['slug' => $post->slug ?? \Str::slug($post->localeTitleShow()) ])}}">{{ $post->localeTitleShow() }}</a></h2>
                                     ...
                                     <br>
                                    <img style="width: 100%" src="{{ route('imagecache', ['template' => 'pnimd', 'filename' => $post->fi()]) }}" alt="">
                                ...
                                <div class="post-image">
                                    <div class="img-thumbnail img-thumbnail-no-borders d-block">
                                        <a href="{{ route('singlePost', ['slug' => $post->slug ?? \Str::slug($post->localeTitleShow()) ])}}">
                                            <img src="{{ route('imagecache', ['template' => 'ppsm', 'filename' => $post->fi()]) }}" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="post-info">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-lg-3">
                                                ...
                                                <article class="post post-medium border-0 pb-0 mb-5">
                                                    <div class="post-image">
                                                        <a href="{{ route('singlePost', ['slug' => $post->slug ?? \Str::slug($post->localeTitleShow()) ])}}">
                                                            <img src="{{  route('imagecache', ['template' => 'pnimd', 'filename' => $post->fi()]) }}" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="post-content">

                                                        <h2 class="font-weight-semibold text-5 line-height-6 mt-3 mb-2"><a href="{{ route('singlePost', ['slug' => $post->slug ?? \Str::slug($post->localeTitleShow()) ])}}"> {!! Str::limit($post->localeTitleShow(),20) !!}</a></h2>

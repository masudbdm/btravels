                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card card-widget">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <label for="linked_url" class="  control-label">LinkedIn Url</label>
                                    <input type="text" name="linked_url" class="form-control" value="{{ old('linked_url') ?: $ws->linked_url ?? '' }}" id="linked_url" placeholder="LinkedIn Url" autocomplete="off">
                                </div>
                                <div class="form-group ">
                                    <label for="whatsapp_url" class="  control-label">WhatsApp Url</label>
                                    <input type="text" name="whatsapp_url" class="form-control" value="{{ old('whatsapp_url') ?: $ws->whatsapp_url ?? '' }}" id="whatsapp_url" placeholder="WhatsApp Url" autocomplete="off">
                                </div>
                                <div class="form-group ">
                                    <label for="instagram_url" class="  control-label">Instagram Url</label>
                                    <input type="text" name="instagram_url" class="form-control" value="{{ old('instagram_url') ?: $ws->instagram_url ?? '' }}" id="instagram_url" placeholder="Instagram Url" autocomplete="off">
                                </div>

                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="page_type">
                              ...
                              <option value="umrah">Umran</option>
      ...
      <div class="card card-widget" style="font-size: 16px;">
        ...
        <div class="card-body">
            <div class="row data-container">
                <div class="col-sm-12 connectedSortable ui-sortable shadow-lg" id="sortablePanel"  data-url="{{ route('admin.pageSort') }}">
                @foreach ($pages as $page)
                <div class="card mb-3 shadow-lg w3-border w3-border-red p-2" id="{{ $page->id }}">
                    ...
                    {{-- link and copy end --}}
                        ...
                        <div class="float-right d-flex">
                            ...
                            @if($page->page_type)
                            <form onclick="return confirm('Do you really want to delete this page? Atfirst update page type nullable');">
                                @csrf
                                <button type="button" class="btn btn-primary btn-sm">{{ucfirst($page->page_type)}}</button>
                            </form>
                            @else

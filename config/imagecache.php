...
return [
    ...
    */
    ...
    'paths' => [
        ...
        public_path('storage/tour_package_image'),
        public_path('storage/testimonial'),
        public_path('storage/tours'),
    ...
    */
    ...
    'templates' => array(
        ...
        'ProjectImage' => 'App\ImageFilters\ProjectImage',
        'BlogPostImage' => 'App\ImageFilters\BlogPostImage',
        'HajjPackage' => 'App\ImageFilters\HajjPackage',
    ),
